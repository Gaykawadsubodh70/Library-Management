...
void Veiw_Books(){
    ...
    while(fread(&showBook,sizeof(showBook),1,fp)){
        ...
        printf("\n\t\t\t Book id = %d",showBook.book_id);

        printf("\n\n\t\t\t Book Name = %s",showBook.bookName);

        printf("\n\t\t\t Author Name = %s",showBook.AuthorName);

        // printf("\n\t\t\t Student Name = %s",showBook.StudentName);

        // printf("\n\t\t\t Student Adress = %d",showBook.Student_Adress);

        printf("\n\t\t\t Date (dd/mm/yy) = (%d/%d/%d)",showBook.issueDate.day,

        showBook.issueDate.month,

        showBook.issueDate.year);

        printf("\n\n\t\t\t-------------------------------------------------------------------------\n");

        // printf("\n%d %s %s %d %d/%d/%d",showBook.book_id,showBook.bookName,showBook.issueDate.day,
...

        {
...

            {
...

                {
                    ...
                    printf("\n\t\t\t Book Name = %s",a.bookName);

                    printf("\n\t\t\t Author Name = %s",a.AuthorName);

                    // printf("\n\t\t\t Student Name = %s",a.StudentName);

                    // printf("\n\t\t\t Student Adress = %d",a.Student_Adress);

                    printf("\n\t\t\t Date (dd/mm/yy) = (%d/%d/%d)",a.issueDate.day,
